...
namespace BeardedManStudios.Forge.Networking.Generated
{
	...
	public partial class MovableObjectNetworkObject : NetworkObject
	{
		...
		public MovableObjectNetworkObject() : base() { Initialize(); }
		public MovableObjectNetworkObject(NetWorker networker, INetworkBehavior networkBehavior = null, int createCode = 0, byte[] metadata = null) : base(networker, networkBehavior, createCode, metadata) { Initialize(); }
		public MovableObjectNetworkObject(NetWorker networker, uint serverId, FrameStream frame) : base(networker, serverId, frame) { Initialize(); }
